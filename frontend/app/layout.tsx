...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <Web3Context.Provider value={{ greeterContractInstance, setGreeterContractInstance, greeting, setGreetingMessage, nfts, setNfts, provider, setProvider, signer, setSigner }}>
